	...
	<footer class="footer-area bg-f">
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<h3>About Us</h3>
					<p>One of the best restaurant in the town.</p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>UseFull Links</h3>
				...
				<div class="col-lg-3 col-md-6">
					...
					<p class="lead">Paknajol,Kathmandu</p>
					<p class="lead"><a href="#">+977 9800000000</a></p>
					<p><a href="#"> swaadghar@gmail.com</a></p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>Opening hours</h3>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name"> &copy; 2025 <a href="#">swaadghar  Restaurant</a> 
