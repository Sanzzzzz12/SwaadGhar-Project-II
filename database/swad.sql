...
DROP DATABASE IF EXISTS `swaadghar `;
CREATE DATABASE IF NOT EXISTS `swaadghar ` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `swaadghar `;
...
(88, 38, 'abcd', 'samir', 9818453551, 'samirdotel1234@gmail.com', 'Balaju'),
(89, 40, 'abcd', 'samir', 9818453551, 'samirdotel1234@gmail.com', 'Balaju');
...
(72, 'kathiyawadi', 'Chicken Momo'),
(73, 'kathiyawadi', 'Veg Momo'),
(74, 'kathiyawadi', 'Buff Momo'),
(75, 'kathiyawadi', 'Fry Chicken Momo'),
(76, 'kathiyawadi', 'Fry Chicken C Momo'),
(77, 'kathiyawadi', 'Fry Buff Momo'),
(78, 'rajsthani', 'Chicken Chowmein'),
(83, 'rajsthani', 'Chop suey'),
(84, 'rajsthani', 'Thupka'),
(85, 'rajsthani', 'Buff Chowmein'),
(86, 'rajsthani', 'Veg Chowmein'),
(87, 'rise', 'Dal Bhat'),
(88, 'rise', 'Chicken Dal Bhat'),
(89, 'tava', 'Chicken Burger'),
(90, 'tava', 'Buff Burger'),
(91, 'kathiyawadi', 'Veg Momo');
...
(7, 'Samir', 'Exellent', 'Nice restaurant'),
(8, 'Ram', 'Good', 'Nice Place'),
(9, 'Hari', 'Exellent', 'Good Foods');
...
--
ALTER TABLE `checkout`
  MODIFY `id` bigint(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;

--
-- AUTO_INCREMENT for table `food_cat`
--
ALTER TABLE `food_cat`
  MODIFY `id` bigint(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
